...
import { DEFAULT_COSTS, type CostConstants } from '../graph/cost.js';
...
export async function calibrate(device: GPUDevice, duck: Duck): Promise<CalibrationReport> {
...
async function timeQuery(duck: Duck, sql: string, reps: number): Promise<number> {
